# Phase 09: Hardening (battery, crashes, release APK)

> Bundled phase plan (phase-09). Execute sub-plans **in order** on one branch.

---

<!-- from plans/010-hardening-battery-crashes-release.md -->
