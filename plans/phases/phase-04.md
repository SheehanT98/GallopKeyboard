# Phase 04: PanelController + VoicePanel scaffold

> Bundled phase plan (phase-04). Execute sub-plans **in order** on one branch.

---

<!-- from plans/004-panel-controller-and-voice-panel-scaffold.md -->
