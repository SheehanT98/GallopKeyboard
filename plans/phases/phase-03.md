# Phase 03: Android CI + sideload baseline

> Bundled phase plan (phase-03). Execute sub-plans **in order** on one branch.

---

<!-- from plans/003-android-ci-and-sideload-baseline.md -->
