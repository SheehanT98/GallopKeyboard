...
| job-022 | conflict_hold | Execute plan 033 async mic permission and polish ic | `cursor/devteam-job-022-execute-plan-033-async-mic-permission-and-polish-c1fc` | — | — |
...
- **job-020** — Wire SuggestionBar + English dictionary defaults · PR 49
- **job-021** — Execute plan 031 stop swipe recomposition jank · PR 50
